    ...
    <div class="max-w-md w-full">
      ...
      <form class="mt-8">
        ...
        <div class="mt-6">
          ...
          <p
            class="mt-3 text-center text-sm font-medium text-blue-600 group-hover:text-blue-400 transition ease-in-out duration-150"
          >
            Don't have an account?
            <nuxt-link :to="{ name: 'register' }" class="underline"
